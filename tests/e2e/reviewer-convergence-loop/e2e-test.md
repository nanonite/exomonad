...
- Do NOT manually trigger a reviewer or simulate a review; the watcher auto-spawns the reviewer when the PR is observed, and the fixture-local reviewer context forces the initial request-changes verdict.
