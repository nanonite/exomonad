...
# E2E reviewer hardening + authorship preservation test.
...
WORK_DIR="$(mktemp -d "$HOME/.cache/exomonad-e2e/authorship.XXXXXXXX")"
...
"$SCRIPT_DIR/validate.sh" "$REPO_DIR" "$EXOMONAD_BIN" "$RESULT_FILE"
