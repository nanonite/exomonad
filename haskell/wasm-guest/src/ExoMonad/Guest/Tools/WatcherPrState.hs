...
watcherPrStateResponseValue resp =
  object
    [ "success" .= True,
      ...
      "pr_head_tree_sha" .= lazyText (PA.watcherPrStateResponsePrHeadTreeSha resp),
      "merge_commit_sha" .= lazyText (PA.watcherPrStateResponseMergeCommitSha resp),
      "merge_commit_tree_sha" .= lazyText (PA.watcherPrStateResponseMergeCommitTreeSha resp),
