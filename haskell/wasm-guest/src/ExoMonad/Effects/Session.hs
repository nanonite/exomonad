...
data SessionListAgents

instance Effect SessionListAgents where
  type Input SessionListAgents = ListAgentsRequest
  type Output SessionListAgents = ListAgentsResponse
  effectId = "session.list_agents"
