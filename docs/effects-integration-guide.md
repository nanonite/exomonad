...
- **Rust:** `MyEffects` trait and `dispatch_myns_effect` function (generated by `exomonad-core/build.rs`)
...
`exomonad-core/build.rs` reads proto service definitions and generates:
